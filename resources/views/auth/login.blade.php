    ...
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <div class="row justify-content-center form-bg-image"
                data-background-lg="{{ asset('assets/img/illustrations/401.svg') }}">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1">
                                            <svg class="icon icon-xs text-gray-600" xmlns="http://www.w3.org/2000/svg"
                                                width="20" height="20" fill="currentColor" class="bi bi-person-fill"
                                                viewBox="0 0 16 16">
                                                <path
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group" id="show_hide_password">
                                    ...
                                    <span class="input-group-text" id="password">
                                        <a class="px-1"><i class="bi bi-eye-slash" aria-hidden="true"></i></a>
                                    </span>
                                    {{-- <div class="input-group-append">
                                        <a class="btn btn-outline-primary"><i class="bi bi-eye-slash" aria-hidden="true"></i></a>
                                    </div> --}}
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
